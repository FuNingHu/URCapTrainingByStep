...
public class ETProgramNodeContribution implements ProgramNodeContribution {
	...
	public String getTitle() {
		// TODO Auto-generated method stub
		return "EntryTrain: "+"DO"+getIOSelection().toString()+" t="+getDuration(); //E7 implementation
	}

	@Override
	public boolean isDefined() {
		// TODO Auto-generated method stub
		return true; //E7 implementation
	}

	@Override
	public void generateScript(ScriptWriter writer) {
		writer.appendLine("set_standard_digital_out(" + getIOSelection() + ",True)"); // E7 implementation
		writer.sleep(getDuration());
		writer.appendLine("set_standard_digital_out(" + getIOSelection() + ",False)");
		writer.sleep(getDuration());
	}
